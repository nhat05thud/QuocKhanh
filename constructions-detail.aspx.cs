...
public partial class constructions_detail : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (dv.Count > 0)
            {
                ...
                hdnLinkCat.Value = Utils.progressTitle(dv[0]["ProjectCategoryName"].ToString()) + "-ct-" + dv[0]["ProjectCategoryID"].ToString() + ".aspx";
