<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="mail.aspx.cs" Inherits="ad_single_article" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        ...
        <asp:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" Culture="vi-VN" AllowMultiRowSelection="True"
            ...
            OnItemDataBound="RadGrid1_ItemDataBound" CssClass="grid" AllowAutomaticUpdates="True" PageSize="50"
            CellSpacing="0">
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn Visible="false" HeaderText="ID" DataField="ArticleID" SortExpression="ArticleID">
                    </asp:GridBoundColumn>
                    <asp:GridBoundColumn DataField="Tag" HeaderText="Host" SortExpression="Tag" />
                     <asp:GridTemplateColumn DataField="Priority" HeaderStyle-Width="1%" HeaderText="Port"
                        SortExpression="Priority">
                        <ItemTemplate>
                            <asp:RadNumericTextBox ID="txtPriority" runat="server" Width="70px" Text='<%# Bind("Priority") %>'
                                ShowSpinButtons="true" MinValue="0" EmptyMessage="Port..." Type="Number">
                                <NumberFormat AllowRounding="false" DecimalDigits="0" GroupSeparator="." />
                            </asp:RadNumericTextBox>
                        </ItemTemplate>
                    </asp:GridTemplateColumn> 
                    <asp:GridBoundColumn DataField="ArticleTitle" HeaderText="Mail gửi" SortExpression="ArticleTitle" />
                     <asp:GridBoundColumn DataField="MetaTittle" HeaderText="UserName" Visible="false" SortExpression="MetaTittle" />
                     <asp:GridBoundColumn DataField="MetaDescription" HeaderText="Password" SortExpression="MetaDescription" />
                     <asp:GridBoundColumn DataField="TagEn" HeaderText="Mail nhận" SortExpression="TagEn" />
                     <asp:GridBoundColumn DataField="MetaTittleEn" HeaderText="Mail CC" SortExpression="MetaTittleEn" />
                     <asp:GridBoundColumn DataField="MetaDescriptionEn" HeaderText="Mail BCC" SortExpression="MetaDescriptionEn" />
                    
                    <asp:GridTemplateColumn HeaderText="Gmail" SortExpression="IsNew">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn Visible="false" DataField="IsAvailable" HeaderText="Hiển thị" SortExpression="IsAvailable">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn Visible="false" DataField="ImageName" HeaderText="Ảnh" SortExpression="ImageName">
                        <ItemTemplate>
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Mail setting</h3>
                            ...
                            <table class="search">
                                ...
                                <tr class="invisible">
                                    <td class="left" colspan="2">
                                        ...
                                        &nbsp;&nbsp;
                                        <asp:CheckBox ID="chkIsNew" runat="server" CssClass="checkbox" Text=" Gmail" Checked='<%# (Container is GridEditFormInsertItem) ? false : (string.IsNullOrEmpty(Eval("IsNew").ToString()) ? false : Eval("IsNew"))%>' />
                                        &nbsp;&nbsp;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:RadEditor ID="txtDescription" runat="server" Language="vi-VN" Skin="Office2007"
                                                ...
                                                <DocumentManager DeletePaths="~/Uploads/File/" UploadPaths="~/Uploads/File/" ViewPaths="~/Uploads/File/" MaxUploadFileSize="50000000" />
                        ...
                        <asp:RadInputManager ID="RadInputManager2" runat="server">
                            <asp:NumericTextBoxSetting AllowRounding="False" Culture="vi-VN" EmptyMessage="Port ..."
