...
public partial class ad_single_banner : System.Web.UI.Page
{
    ...
    void DeleteImage(string strFileName)
    {
        ...
        {
            string strOldImagePath = Server.MapPath("~/res/banner/" + strFileName);
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "DeleteSelected")
        {
            ...
            foreach (GridDataItem item in RadGrid1.SelectedItems)
            {
                ...
                if (!string.IsNullOrEmpty(strFileName))
                {
                    string strSavePath = Server.MapPath("~/res/banner/" + strFileName);
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            string strAdsCategoryID = "1";// ((RadComboBox)row.FindControl("ddlCategory")).SelectedValue;
            string strDescription = ((TextBox)row.FindControl("txtDescription")).Text.Trim();//FCKEditorFix.Fix(((RadEditor)row.FindControl("txtDescription")).Content.Trim());
            ...
            if (e.CommandName == "PerformInsert")
            {
                ...
                string strFullPath = "~/res/banner/" + strFileName;
            ...
            else
            {
                ...
                var strOldImagePath = Server.MapPath("~/res/banner/" + strOldFileName);

                oAdsBanner.AdsBannerUpdate(strAdsBannerID,
                     strFileName,
                     strConvertedAdsBannerName,
                     strAdsCategoryID,
                     strCompanyName,
                ...
                if (!string.IsNullOrEmpty(strFileName))
                {
                    var strFullPath = "~/res/banner/" + (string.IsNullOrEmpty(strConvertedAdsBannerName) ? "" : strConvertedAdsBannerName + "-") + strAdsBannerID + strFileName.Substring(strFileName.LastIndexOf('.'));
