...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server">
            ...
            <table class="search">
                <tr>
                    <td class="left">Tên Tin Tức
                    </td>
                    <td>
                        <asp:RadTextBox ID="txtSearchProjectTitle" runat="server" Width="130px" EmptyMessage="Tên Tin Tức...">
                        </asp:RadTextBox>
                    </td>
        ...
        <asp:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" Culture="vi-VN" AllowMultiRowSelection="True"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn DataField="ProjectTitle" HeaderText="Tên Tin Tức" SortExpression="ProjectTitle" />
                    <asp:GridBoundColumn DataField="ProjectTitleEn" HeaderText="Tên Tin Tức En" SortExpression="ProjectTitleEn" />
                    <asp:GridBoundColumn DataField="ProjectTitleCn" HeaderText="Tên Tin Tức Cn" SortExpression="ProjectTitleCn" />
                                ...
                                <tr>
                                    <td valign="top">
                                                    ...
                                                    <tr >
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <%--<asp:RadAsyncUpload ID="FileImageName" runat="server"
                                                                TargetFolder="~/res/news/album/" TemporaryFolder="~/res/TempAsync" Width="100%"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtProjectTitle" runat="server" Text='<%# Bind("ProjectTitle") %>'
                                                                Width="500px" EmptyMessage="Tên Tin Tức...">
                                                            </asp:RadTextBox>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtProjectTitle"
                                            Display="Dynamic" ErrorMessage="Nhập tên Tin Tức" SetFocusOnError="true">*</asp:RequiredFieldValidator>--%>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtProjectTitleEn" runat="server" Text='<%# Bind("ProjectTitleEn") %>'
                                                                EmptyMessage="Tên Tin Tức..." Width="500px">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                            ...
                                                            <asp:RadListView runat="server" ID="RadListView1" DataSourceID="OdsProjectPhotoAlbum"
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <fieldset style="float: left; margin: 5px; padding: 2px 2px 2px 2px; position: relative; background: #eeeeee;"
                                                                        class="myClass">
                                                                        <a href='<%# "~/res/news/album/" + Eval("ImageName") %>' runat="server" class="lightbox">
                                                                            <img alt="" src='<%# "~/res/news/album/thumbs/" + Eval("ImageName") %>' runat="server"
                ...
                <%--<EditFormSettings ColumnNumber="2" CaptionDataField="ProjectTitle" CaptionFormatString="Thông Tin Tin Tức: {0}"
                    InsertCaption="Tin Tức Mới">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProjectSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchDescription" Name="Description" PropertyName="Text"
                Type="String" />
            <asp:Parameter Name="ProjectCategoryID" Type="String" DefaultValue="4" />
