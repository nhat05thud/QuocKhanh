<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="motaGioiThieu.aspx.cs" Inherits="ad_single_projectcategory" %>
                ...
                <EditFormSettings EditFormType="Template">
                    ...
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Mô Tả Giới Thiệu</h3>
                            <table class="search">
                                <tr class="invisible">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtProjectCategoryName" runat="server" Text='<%# (Container is GridEditFormInsertItem) ? "" : (string.IsNullOrEmpty(Eval("ProjectCategoryName").ToString()) ? "" : Eval("ProjectCategoryName")) %>'
