...
public partial class ad_single_project : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            string Tag = FCKEditorFix.Fix(((RadEditor)row.FindControl("txtTag")).Content.Trim()); 
            ...
            string TagEn = FCKEditorFix.Fix(((RadEditor)row.FindControl("txtTagEn")).Content.Trim()); 
            ...
            string DescriptionCn = FCKEditorFix.Fix(((RadEditor)row.FindControl("txtDescriptionCn")).Content.Trim());
            string ContentCn = FCKEditorFix.Fix(((RadEditor)row.FindControl("txtContentCn")).Content.Trim());
            string TagCn = FCKEditorFix.Fix(((RadEditor)row.FindControl("txtTagCn")).Content.Trim()); 
