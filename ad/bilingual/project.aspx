...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server">
            ...
            <table class="search">
                <tr>
                    <td class="left">Tên Công Trình
                    </td>
                    <td>
                        <asp:RadTextBox ID="txtSearchProjectTitle" runat="server" Width="130px" EmptyMessage="Tên Công Trình...">
                        </asp:RadTextBox>
                    </td>
        ...
        <asp:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" Culture="vi-VN" AllowMultiRowSelection="True"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn DataField="ProjectTitle" HeaderText="Tên Công Trình" SortExpression="ProjectTitle" />
                    <asp:GridBoundColumn DataField="ProjectTitleEn" HeaderText="Tên Công Trình En" SortExpression="ProjectTitleEn" />
                    <asp:GridBoundColumn DataField="ProjectTitleCn" HeaderText="Tên Công Trình Cn" SortExpression="ProjectTitleCn" />
                    ...
                    <asp:GridTemplateColumn DataField="ImageName" HeaderText="Ảnh" SortExpression="ImageName">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ImageName").ToString()) ? false : true %>'
                                Width="95">
                                <img alt="" src='<%# "~/res/project/" + Eval("ImageName") %>' width="80" runat="server"
                                ...
                                <tr>
                                    <td valign="top" style="width: 500px">
                                                    ...
                                                    <tr class="invisible">
                                                        <td class="left" colspan="2">
                                                            <asp:CheckBox ID="chkIsShowOnHomePage" runat="server" CssClass="checkbox" Text=" Xem trên trang chủ"
                                                                Checked='<%# (Container is GridEditFormInsertItem) ? false : (string.IsNullOrEmpty(Eval("IsShowOnHomePage").ToString()) ? false : Eval("IsShowOnHomePage"))%>' />
                                                            &nbsp;&nbsp;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtProjectTitle" runat="server" Text='<%# Bind("ProjectTitle") %>'
                                                                Width="500px" EmptyMessage="Tên Công Trình...">
                                                            </asp:RadTextBox>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtProjectTitle"
                                            Display="Dynamic" ErrorMessage="Nhập tên Công Trình" SetFocusOnError="true">*</asp:RequiredFieldValidator>--%>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtDescription" runat="server" Text='<%# Bind("Description") %>'
                                                                Width="500px" EmptyMessage="Mô tả..." TextMode="MultiLine" Height="100">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtProjectTitleEn" runat="server" Text='<%# Bind("ProjectTitleEn") %>'
                                                                EmptyMessage="Tên Công Trình..." Width="500px">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtDescriptionCn" runat="server" Text='<%# Bind("DescriptionCn") %>'
                                                                Width="500px" EmptyMessage="Mô tả..." TextMode="MultiLine" Height="100">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadEditor ID="txtContentCn" runat="server" Language="vi-VN" Skin="Office2007"
                                                                Width="500px" Content='<%# Bind("ContentCn") %>'>
                                                                <ImageManager DeletePaths="~/Uploads/Image/" UploadPaths="~/Uploads/Image/" ViewPaths="~/Uploads/Image/" MaxUploadFileSize="1000000" />
                                                                <FlashManager DeletePaths="~/Uploads/Video/" UploadPaths="~/Uploads/Video/" ViewPaths="~/Uploads/Video/" />
                                                                <DocumentManager DeletePaths="~/Uploads/File/" UploadPaths="~/Uploads/File/" ViewPaths="~/Uploads/File/" MaxUploadFileSize="1000000" />
                                                                <MediaManager DeletePaths="~/Uploads/Media/" UploadPaths="~/Uploads/Media/" ViewPaths="~/Uploads/Media/" />
                                                    ...
                                                    <asp:Panel ID="Panel3" runat="server" Visible="false">
                                                        ...
                                                        <tr>
                                                            <td class="left">Tag(Cn)
                                                            </td>
                                                            <td>
                                                                <asp:RadTextBox ID="txtTagCn" runat="server" Width="500px" Text='<%# Bind("TagCn") %>'
                                                                    EmptyMessage="Tag(Cn)...">
                                                                </asp:RadTextBox>
                                                            </td>
                                                        </tr>
                ...
                <%--<EditFormSettings ColumnNumber="2" CaptionDataField="ProjectTitle" CaptionFormatString="Thông Tin Công Trình: {0}"
                    InsertCaption="Công Trình Mới">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProjectSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchDescription" Name="Description" PropertyName="Text"
                Type="String" />
            <asp:Parameter Name="ProjectCategoryID" Type="String" DefaultValue="3" />
