...
public partial class ad_single_project : System.Web.UI.Page
{
    ...
    void DeleteImage(string strImageName)
    {
        ...
        {
            var strImagePath = Server.MapPath("~/res/news/" + strImageName);
            var strThumbImagePath = Server.MapPath("~/res/news/thumbs/" + strImageName);
    ...
    void DeletePhotoAlbum(string strImageName)
    {
        if (!string.IsNullOrEmpty(strImageName))
        {
            var strImagePath = Server.MapPath("~/res/news/album/" + strImageName);
            var strThumbImagePath = Server.MapPath("~/res/news/album/thumbs/" + strImageName);
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            if (e.CommandName == "PerformInsert")
            {
                ...
                string strFullPath = "~/res/news/" + ImageName;
            ...
            else
            {
                ...
                var strOldImagePath = Server.MapPath("~/res/news/" + OldImageName);
                var strOldThumbImagePath = Server.MapPath("~/res/news/thumbs/" + OldImageName);
    ...
    protected void RadListView1_ItemCommand(object sender, RadListViewCommandEventArgs e)
    {
        try
        {
            ...
            //    if (!string.IsNullOrEmpty(strImageName))
            //    {
            //        var strOldImagePath = Server.MapPath("~/res/news/album/" + strOldImageName);
            //        var strOldThumbImagePath = Server.MapPath("~/res/news/album/thumbs/" + strOldImageName);
            ...
            //        string strFullPath = "~/res/news/album/" + strImageName;

            //        FileImageName.UploadedFiles[0].SaveAs(Server.MapPath(strFullPath));
            //        ResizeCropImage.ResizeByCondition(strFullPath, 800, 800);
            //        ResizeCropImage.CreateThumbNailByCondition("~/res/news/album/", "~/res/news/album/thumbs/", strImageName, 120, 120);
            //    }
            //}
            //else if (e.CommandName == "Delete")
            //{
    ...
    protected void FileImageAlbum_FileUploaded(object sender, FileUploadedEventArgs e)
    {
        ...
        string targetFolder = "~/res/news/album/";
        ...
        ResizeCropImage.CreateThumbNailByCondition("~/res/news/album/", "~/res/news/album/thumbs/", newName, 120, 120);
    ...
    protected void FileImageName_FileUploaded(object sender, FileUploadedEventArgs e)
    {
        ...
        string targetFolder = "~/res/news/";
        string newName = Guid.NewGuid().GetHashCode().ToString("X") + e.File.GetExtension();
        e.File.SaveAs(Server.MapPath(targetFolder + newName));

        ResizeCropImage.ResizeByCondition(targetFolder + newName, 800, 800);
        ResizeCropImage.CreateThumbNailByCondition("~/res/news/", "~/res/news/thumbs/", newName, 120, 120);
