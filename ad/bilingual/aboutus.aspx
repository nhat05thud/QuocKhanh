...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server" Visible="false">
            ...
            <table class="search">
                <tr>
                    <td class="left">Tên Giới Thiệu
                    </td>
                    <td>
                        <asp:RadTextBox ID="txtSearchProjectTitle" runat="server" Width="130px" EmptyMessage="Tên Giới Thiệu...">
                        </asp:RadTextBox>
                    </td>
                </tr>
                <tr class="invisible">
        ...
        <asp:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" Culture="vi-VN" AllowMultiRowSelection="True"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn DataField="ProjectTitle" HeaderText="Tên Giới Thiệu" SortExpression="ProjectTitle" />                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
                    <asp:GridBoundColumn DataField="ProjectTitleEn" HeaderText="Tên Giới Thiệu En" SortExpression="ProjectTitleEn" />                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
                    <asp:GridBoundColumn DataField="ProjectTitleCn" HeaderText="Tên Giới Thiệu Cn" SortExpression="ProjectTitleCn" />
                                ...
                                <tr>
                                    <td valign="top">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtProjectTitle" runat="server" Text='<%# Bind("ProjectTitle") %>'
                                                                Width="500px" EmptyMessage="Tên Giới Thiệu...">
                                                            </asp:RadTextBox>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtProjectTitle"
                                            Display="Dynamic" ErrorMessage="Nhập tên Giới Thiệu" SetFocusOnError="true">*</asp:RequiredFieldValidator>--%>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtProjectTitleEn" runat="server" Text='<%# Bind("ProjectTitleEn") %>'
                                                                EmptyMessage="Tên Giới Thiệu..." Width="500px">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                ...
                <%--<EditFormSettings ColumnNumber="2" CaptionDataField="ProjectTitle" CaptionFormatString="Thông Tin Giới Thiệu: {0}"
                    InsertCaption="Giới Thiệu Mới">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProjectSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchDescription" Name="Description" PropertyName="Text"
                Type="String" />
            <asp:Parameter Name="ProjectCategoryID" Type="String" DefaultValue="1" />
