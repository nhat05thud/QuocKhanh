...
//Thay dia chi web
var endAddress = "10.774873,106.543631";
//Thay toa do
var lat = 10.774873, long = 106.543631;
window.onload = function () {
    ...
    google.maps.event.addListener(marker, 'click', function () {
        ...
        // Creating the content  
            ...
            '<h1>DNTN THƯƠNG MẠI - XÂY DỰNG QUỐC KHANH</h1>' + '<ul>' +
            '<li class="local">Địa chỉ: 3A54 Trần Văn Giàu, Ấp 3, Xã Phạm Văn Hai, Huyện Bình Chánh, Tp. HCM</li>' +            '<li class="phone">Hotline: 08 8772214 - 877 3939 - Fax: 08 877 3838</li>' +
            '<li class="mail">Email: <a href="mailto:quockhanh@quockhanh.com.vn">quockhanh@quockhanh.com.vn</a></li>' + '</ul>'
        '</div>';
